...
<?php 
            ...
            if (isset($_POST["submit"])) {
              ...
              $imgFolderPath = __DIR__."\\thumbnails\\";
              ...
              $videoFolderPath = __DIR__."\\videos\\";
              ...
              if(!isset($id_update)){
                ...
                header("location:test.php?mod=upload&error=$error");
                exit();
                ...
                header("location:test.php?mod=video&error=$error");
                exit();
              } // END of isset update
            } // END of isset submit
...
<?php
              if (isset($_POST["submit"])) {
                  ...
                  header("location:test.php?mod=category&error=$error");
                  exit();
              }
...
?>
                        <tr class="text-white">
                            ...
                            <td align="center" class="p-1 w-50">
                                ...
                                <button class="btn btn-danger" onclick="confDelete('Do you want to delete this category ?' ,'test.php?mod=delete_cat&id_delete=<?= $row['id']; ?>&redir=category')"> DELETE </button>
                            </td>
                  ...
                  if (!empty($_GET["id_delete"])) {
                    ...
                    if (!$conn->query($sql)) {
                       ...
                       if (!$result = $conn->query($sql)) {
                           $_SESSION["msg"] = "There is an error " . $conn->error;
                           $error = "yes";
                           header("location:test.php?mod=$redir&error=$error");
                           exit();
                       }
                       $row = $result->fetch_array(MYSQLI_ASSOC);
                       $imgFolderPath = __DIR__."\\thumbnails\\";
...
?>
                <div class="col-md-4">
                  ...
                  <div class="btn-group m-2">
                    ...
                    <button class="btn btn-danger" onclick="confDelete('Do you want to delete this content ?' ,'test.php?mod=delete_vid&id_delete=<?= $id; ?>&redir=video')"> DELETE </button>
                  </div>
